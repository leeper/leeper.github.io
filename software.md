...
A simple, one-function R package to produce Edward Tufte-inspired [slopegraph plots](http://www.edwardtufte.com/bboard/q-and-a-fetch-msg?msg_id=0003nk). You can [follow slopegraph's development on GitHub](https://github.com/leeper/slopegraph).
