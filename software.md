...
* **slopegraph: Edward Tufte-inspired Slopegraphs in R**: A simple, one-function R package to produce Edward Tufte-inspired [slopegraph plots](http://www.edwardtufte.com/bboard/q-and-a-fetch-msg?msg_id=0003nk). You can <!--[find slopegraph on CRAN](http://cran.r-project.org/web/packages/slopegraph/index.html) and--> [follow slopegraph's development on GitHub](https://github.com/leeper/slopegraph).
