...
\entry{PhD training plus 5 years academic experience producing quantitative social science research \& teaching quantitative research methods at all levels}
...
\entry{\textbf{Research Scientist}, \textit{Facebook Core Data Science} (2018 -- )}
\entry{\textbf{Associate Professor}, \textit{London School of Economics} (Aug 2017 -- 2018)}
\entry{\textbf{Assistant Professor}, \textit{London School of Economics} (Sep 2015 -- Aug 2017)}
...
\section{Skills}
\entry{Software: R, Stata, LaTeX, MS Office; familiarity with SQL, Python, SPSS, SAS}
