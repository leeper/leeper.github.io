...
\topic{R Packages}
	...
	\entry{``aws.polly: Client for Amazon Polly.'' On \href{https://github.com/cloudyr/aws.polly}{GitHub}.}
...
\topic{Lecturing: London School of Economics and Political Science}
	%\entry{\textit{Research Design} (PhD), LSE, TBD}
	%\entry{\textit{Experimental Politics} (Bachelor), LSE, 2016/17--}
