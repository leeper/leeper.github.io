...
\subentry{Committee: Ben Page, Dennis Chong, \& Fay Lomax Cook}
...
\entry{Toby Bolsen, Thomas J. Leeper, and Matthew Shapiro. 2014. ``Doing What Others Do: Norms, Science, and Collective Action on Global Warming.'' {\em American Politics Research} 42(1): 65--89. 10.1177/1532673X13484173}
\entry{Toby Bolsen, and Thomas J. Leeper. 2013. ``Self-Interest and Attention to News among Issue Publics.'' {\em Political Communication} 30(3): 329--348. 10.1080/10584609.2012.737428}
\entry{James N. Druckman, and Thomas J. Leeper. 2012. ``Learning More from Political Communication Experiments: Pretreatment and Its Effects.'' {\em American Journal of Political Science} 56(4): 875--896. 10.1111/j.1540-5907.2012.00582.x}
\entry{James N. Druckman, and Thomas J. Leeper. 2012. ``Is Public Opinion Stable? Resolving the Micro-Macro Disconnect in Studies of Public Opinion.'' {\em Daedalus} 141(4): 50--68. 10.1162/DAED_a_00173}
\entry{James N. Druckman, Jordan Fein, and Thomas J. Leeper. 2012. ``A Source of Bias in Public Opinion Stability.'' {\em American Political Science Review} 106(2): 430--454. 10.1017/S0003055412000123}

\topic{Forthcoming}
\entry{Thomas J. Leeper. 2014. ``The Informational Basis for Mass Polarization.'' {\em Public Opinion Quarterly}.}
...
%\entry{Thomas J. Leeper. ``Can Surveys Demonstrate Selective Exposure?''}
...
\entry{Thomas J. Leeper. ``Making High-Resolution Graphics for Academic Publishing.'' {\em The Political Methodologist}.}
...
\section{Software}
\entry{``dvn: Access to The Dataverse Network APIs.'' Available at \href{http://cran.r-project.org/web/packages/dvn/index.html}{CRAN}.}
\entry{``MTurkR: Access to Amazon Mechanical Turk Requester API.'' Available at \href{http://cran.r-project.org/web/packages/MTurkR/index.html}{CRAN}.}
\entry{``rite: The Right Editor to Write R.'' Available at \href{http://cran.r-project.org/web/packages/rite/index.html}{CRAN}.}
\entry{``slopegraph: Edward Tufte-inspired Slopegraphs in R.'' Available at \href{https://github.com/leeper/slopegraph}{GitHub}}
\entry{``sparktex: Generate LaTeX sparklines in R.'' Available at \href{http://cran.r-project.org/web/packages/sparktex/index.html}{CRAN}.}
\entry{``UNF: Tools for creating universal numeric fingerprints for data.'' Available at \href{https://github.com/leeper/UNF}{GitHub}}
...
\section{Teaching}
\topic{Experience}
%\entry{Instructor, {\em Contemporary Issues in American Politics} (Master), Aarhus University, 2014}
...
\entry{Panel Discussant:\\AAPOR (2013), APSA (2012), DPSA (2013), ISPP (2012), MPSA (2014)}
