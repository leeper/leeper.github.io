...
\entry{Thomas J. Leeper. ``How Does Treatment Self-Selection Affect Inferences About Political Communication?'' Revise and Resubmit.}
...
\entry{Thomas J. Leeper. ``The Multiple Paths to Credibility.'' Under review.}
...
\entry{``lumendb: Lumen Database API Client.'' On \href{https://github.com/leeper/lumendb}{GitHub}.}
...
\entry{``MTurkRGUI: A Graphical User Interface for MTurkR.'' On \href{https://github.com/leeper/MTurkRGUI}{GitHub}.}
...
\entry{``dataverse: R Dataverse Client.'' On \href{https://github.com/iqss/dataverse-client-r}{GitHub} (in collaboration with IQSS at Harvard University.}
...
%\entry{``Can Citizens Be Framed? How Information, Not Emphasis, Changes Opinions.'' Mapping Political Preferences Conference, Institute for Advanced Study-Toulouse, Toulouse, France, 2016.}
