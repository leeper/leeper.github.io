...
\entry{``webuse: Import Stata 'webuse' Datasets.'' On \href{https://github.com/leeper/webuse}{GitHub}.}
...
%\entry{``crowdflower: Crodflower.com R Client.'' On \href{https://github.com/leeper/crowdflower}{GitHub} (with Ken Benoit).}
