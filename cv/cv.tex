...
\entry{Facebook}
	\subentry{Research Scientist, Core Data Science (from Sep 2018)}
\entry{London School of Economics and Political Science}
    %\subentry{Senior Visiting Fellow, Methodology Department (2018--)}
    \subentry{Associate Professor in Political Behaviour, Government Department (2017--2018)}
...
\topic{Chapters in Edited Volumes}
	\entry{Thomas J. Leeper. ``The Search for Real-World Media Effects.'' In Zoe Oxley and David Redlawsk, eds., \textit{Oxford Encyclopedia of Political Decision Making}. Under review.}
    \entry{Thomas J. Leeper, and Rune Slothuus. ``Framing: How the Media Persuade.'' In Liz Suhay, Bernard Grofman, and Alex Treschel, eds., \textit{Oxford Handbook of Electoral Persuasion}. Under review.}
    \entry{Thomas J. Leeper. ``Online Experimental Methods.'' In Liz Suhay, Bernard Grofman, and Alex Treschel, eds., \textit{Oxford Handbook of Electoral Persuasion}. Under review.}
...
\topic{Papers Under Review}
	...
	\entry{Thomas J. Leeper, and Joshua Robison. ``More Important, but for What Exactly? The Insignificant Role of Subjective Issue Importance in Vote Decisions.'' Revise and Resubmit.}
...
\topic{Working Papers}
    ...
    \entry{Sara B. Hobolt, Thomas J. Leeper, and James Tilley. ``Measuring Subgroup Preferences in Conjoint Experiments.''}
    \entry{Sara B. Hobolt, Thomas J. Leeper, and James Tilley. ``Divided by the Vote: Affective Polarization in the Wake of Brexit.''}
    %\entry{Sara B. Hobolt, and Thomas J. Leeper. ``The Politically Undeserving Farmer.''}
...
\topic{R Packages: Major Contributions \& Retired Packages}
