...
\topic{Under Review}
\entry{Thomas J. Leeper. ``Archiving Reproducible Research with R and Dataverse.'' Conditional Accept, {\em The R Journal}.}
...
\entry{``pollstR: R client for the Pollster API.'' Available from \href{https://github.com/leeper/pollstR}{GitHub}}
...
\entry{Contributor, \href{http://ropensci.org/}{rOpenSci}}
\entry{Contributor, \href{http://ropengov.github.io/}{rOpenGov}}
