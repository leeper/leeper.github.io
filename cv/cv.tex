...
\topic{Other Publications}
	\entry{Thomas J. Leeper. ``The Multiple Paths to Credibility.'' \textit{The Political Methodologist}: In press.}
	...
	\entry{Thomas J. Leeper. 2014. ``Making High-Resolution Graphics for Academic Publishing.'' \textit{The Political Methodologist} 21(1): 2--5.}
	\entry{Thomas J. Leeper. 2013. ``Crowdsourcing with R and the MTurk API.'' \textit{The Political Methodologist} 2(2): 2--7.}
	\entry{Thomas J. Leeper. 2011. ``The Role of Protocol in the Design and Reporting of Experiments.'' \textit{The Experimental Political Scientist} 2(1): 6-10.}%
...
%\topic{Other Publications}
%	\entry{Thomas J. Leeper. 2016. ``Review of \textit{Candidate-Centered Campaigns} by Brian Arbour.'' \textit{Public Opinion Quarterly}.}

\section{Grants\\and\\Funding}
\topic{External Sources}
	\entry{R Consortium Infrastructure Steering Committee Grant (2016)}
...
\topic{R Packages}
	...
	\entry{``ghit: Lightweight GitHub Package Installer.'' On \href{https://cran.r-project.org/package=ghit}{CRAN}, \href{https://github.com/leeper/ghit}{GitHub}.}
...
\topic{R packages contributed to the cloudyr project}
	...
	\entry{``aws.glacier: Amazon Web Services Glaicer Client.'' On \href{https://github.com/cloudyr/aws.glacier}{GitHub}.}
...
\topic{Experience: London School of Economics and Political Science}
	...
	\entry{Instructor, \textit{Research Design in Political Science} (Bachelor), LSE, 2015--2016}
...
% \entry{Speaker, Undergraduate Open Day (2016)}
	\entry{Hiring committee, EUDEMOS project Postdoc (2016)}
