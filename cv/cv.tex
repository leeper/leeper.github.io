...
\topic{Peer-Reviewed Publications: Political Science}
    %\entry{Thomas J. Leeper. 2017. ``Am I a Methodologist? Asking for a Friend.'' \textit{PS: Political Science \& Politics}.}
...
\topic{Chapters in Edited Volumes}
	...
	%\entry{Samara Klar, and Thomas J. Leeper. 20xx. ``Identities and Intersectionality: A Case for Purposive Sampling in Survey Experimental Research.'' \textit{Experimental Methods in Survey Research: Techniques that Combine Random Sampling with Random Assignment}.}
...
\topic{Other Academic Publications}
    %\entry{Thomas J. Leeper, and Kevin J. Mullinix. 201x. ``Motivated Reasoning.'' \textit{Oxford Bibliographies}.}
...
\section{Invited\\Presentations\\\& Conference\\Papers}
    ...
    %entry{``Building a Modern Amazon Web Services Software Development Kit for R.'' Genentech, San Francisco, California, US.}
...
\topic{Master Thesis Examinations}
    \entry{University of Greenwich (2017): Nigel Gervas}
