...
\entry{``rite: The Right Editor to Write R.'' On \href{https://cran.r-project.org/package=rio}{CRAN}, \href{https://github.com/leeper/rio}{GitHub}.}
...
%\entry{``crowdflower: Crodflower.com R Client.'' On \href{https://github.com/leeper/crowdflower}{GitHub} (with Ken Benoit, Pablo Barber\'{a}).}
