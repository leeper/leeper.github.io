...
\topic{Forthcoming}
\entry{Thomas J. Leeper. 2014. ``The Informational Basis for Mass Polarization.'' {\em Public Opinion Quarterly}. doi:10.1093/poq/nft045}
...
\entry{``pollstR: R client for the Pollster API.'' On \href{https://github.com/rOpenGov/pollstR}{GitHub}}
...
\entry{Panel Discussant:\\AAPOR (2013), APSA (2012, 2014), DPSA (2013), ISPP (2012), MPSA (2014)}
