...
\entry{Government Department, London School of Economics and Political Science}
...
\entry{Department of Political Science and Government, Aarhus University}
...
\topic{Chapters in Edited Volumes}
	\entry{Thomas J. Leeper. ``The Search for Real-World Media Effects.'' In Zoe Oxley and David Redlawsk, eds., \textit{Oxford Encyclopedia of Political Decision Making}: In press.}
...
\topic{Papers Under Review}
    ...
    \entry{Alexander Coppock, Thomas J. Leeper, and Kevin J. Mullinix. ``The Generalizability of Heterogeneous Treatment Effect Estimates Across Samples.'' Revise and Resubmit.}
...
\topic{Editing}
	\entry{Editor, \href{http://joss.theoj.org/}{\textit{Journal of Open Source Software}} (2017--)}
