...
%\usepackage{lmodern} % new sans serif font
...
\entry{James N. Druckman, Thomas J. Leeper, and Kevin J. Mullinix. ``The Experimental Study of Legislative Behaviors.'' In Thomas Saalfeld, and Kaare Str\o m, eds., {\em The Oxford Handbook of Legislative Studies}. Oxford, UK: Oxford University Press.}
\entry{Thomas J. Leeper, and Rune Slothuus. ``Political Reasoning and Elite Partisan Competition.'' {\em Advances in Political Psychology}.}
...
\entry{Thomas J. Leeper, and Kevin J. Mullinix. ``Are Population-based Survey Experiments Unparalleled?''}
...
%\entry{Yanna Krupnikov and Thomas J. Leeper. ``Assessing the MTurk Marketplace''}
...
\entry{``dvn: Access to The Dataverse Network API.'' 2013. Available at \href{http://cran.r-project.org/web/packages/dvn/index.html}{CRAN}.}
...
%\entry{Instructor, {\em Quantitative Data Analysis} (Master), Aarhus University, 2014.}
...
\topic{Disciplinary}
\entry{Reviewer: {\em American Journal of Political Science}, {\em American Political Science Review}, {\em American Politics Research}, {\em British Journal of Political Science}, {\em Future Internet}, {\em Political Analysis}, {\em Political Behavior}, {\em Political Communication}, {\em Political Research Quarterly}, {\em Political Science Research and Methods}, {\em Public Opinion Quarterly}, {\em SAGE Open}, AAPOR Annual Conference, TESS: Time-Sharing Experiments for the Social Sciences}
