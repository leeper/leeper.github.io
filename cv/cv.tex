...
\entry{Thomas J. Leeper. ``Archiving Reproducible Research with R and Dataverse.'' {\em The R Journal}.}
...
\section{Software}
\entry{``colourlovers: R client for the COLOURlovers API.'' Available from \href{http://cran.r-project.org/web/packages/colourlovers/index.html}{CRAN}.}
\entry{``dvn: Access to The Dataverse Network APIs.'' Available from \href{http://cran.r-project.org/web/packages/dvn/index.html}{CRAN}.}
\entry{``mpg: Fuel economy data from FuelEconomy.gov.'' Available from \href{https://github.com/rOpenGov/mpg}{GitHub}}
\entry{``MTurkR: Access to Amazon Mechanical Turk Requester API.'' Available from \href{http://cran.r-project.org/web/packages/MTurkR/index.html}{CRAN}.}
\entry{``pollstR: R client for the Pollster API.'' Available from \href{https://github.com/rOpenGov/pollstR}{GitHub}}
\entry{``rite: The Right Editor to Write R.'' Available from \href{http://cran.r-project.org/web/packages/rite/index.html}{CRAN}.}
\entry{``slopegraph: Edward Tufte-inspired Slopegraphs in R.'' Available from \href{https://github.com/leeper/slopegraph}{GitHub}}
\entry{``sparktex: Generate LaTeX sparklines in R.'' Available from \href{http://cran.r-project.org/web/packages/sparktex/index.html}{CRAN}.}
\entry{``UNF: Tools for creating universal numeric fingerprints for data.'' Available from \href{https://github.com/leeper/UNF}{GitHub}}
...
\entry{Contributor, \href{http://ropensci.org/}{rOpenSci} (2014-)}
\entry{Contributor, \href{http://ropengov.github.io/}{rOpenGov} (2014-)}
...
\entry{``\href{http://www.psychologytoday.com/blog/polarized}{Polarized},'' a {\em Psychology Today} blog about psychology and public opinion (2012-2013)}
