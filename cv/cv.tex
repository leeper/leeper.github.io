...
\topic{Peer-Reviewed Publications}
	\entry{Thomas J. Leeper. ``Crowdsourced Data Preprocessing with R and Amazon Mechanical Turk.'' \textit{The R Journal}: In press.}
	...
	\entry{Thomas J. Leeper. 2014. ``Archiving Reproducible Research with R and Dataverse.'' \textit{The R Journal} 6(1): 151--158. \href{http://journal.r-project.org/archive/2014-1/leeper.pdf}{http://journal.r-project.org/archive/2014-1/leeper.pdf}.}
...
\topic{Other Publications}
	...
	\entry{Thomas J. Leeper. ``The Multiple Paths to Credibility.'' \textit{The Political Methodologist} 23(1): 11--16.\\ Available from: \url{https://thepoliticalmethodologist.files.wordpress.com/2016/02/tpm_v23_n1.pdf}.}
	...
	\entry{Thomas J. Leeper. 2014. ``Making High-Resolution Graphics for Academic Publishing.'' \textit{The Political Methodologist} 21(1): 2--5.\\ Available from: \url{https://thepoliticalmethodologist.files.wordpress.com/2014/06/tpm_v21_n12.pdf}}
	\entry{Thomas J. Leeper. 2013. ``Crowdsourcing with R and the MTurk API.'' \textit{The Political Methodologist} 2(2): 2--7.\\ Available from: \url{https://thepoliticalmethodologist.files.wordpress.com/2013/09/tpm_v20_n21.pdf}.}
...
\topic{Working Papers and Papers Under Review}
	\entry{Thomas J. Leeper. ``How Does Treatment Self-Selection Affect Inferences About Political Communication?'' Revise and Resubmit, \textit{Journal of Experimental Political Science}.}
	...
	\entry{Thomas J. Leeper, and Rune Slothuus. ``Using the Rolling Reinterview Design to Study Campaigns, Opinions, and Electoral Behavior.'' Under review.}
...
\topic{Book Reviews}
	\entry{Thomas J. Leeper. 2016. ``Review of \textit{Candidate-Centered Campaigns} by Brian Arbour.'' \textit{Public Opinion Quarterly}. In press.}
	\entry{Thomas J. Leeper 2016. ``Review of \textit{Political Analysis Using R} by James E. Monogan, III.'' \textit{The Political Methodologist}. In press.}
...
\topic{R Packages}
	...
	\entry{``tabulizer: Bindings for Tabula PDF Table Extractor Library.'' On \href{https://github.com/leeper/tabulizer}{GitHub}.}
...
\section{Invited\\Presentations\\and\\Conference\\Papers}
...
\topic{Experience: Northwestern University}
	\entry{Teaching Assistant, \textit{Statistical Research Methods} (Bachelor), Northwestern University, 2011} % Jason Seawright
	\entry{Teaching Assistant, \textit{Methods of Political Inference} (Bachelor), Northwestern University, 2011} % Jim Mahoney
	\entry{Teaching Assistant, \textit{Political Psychology of Mass Behavior} (Bachelor), University of Minnesota, 2007} % Chris Galdieri
\topic{Short courses}
...
\topic{Master Supervision, Aarhus University}
...
\topic{Disciplinary}
	...
	\entry{Journal Reviewer:\\\textit{American Journal of Political Science}, \textit{American Political Science Review}, \textit{American Politics Research}, \textit{British Journal of Political Science}, \textit{Comparative Political Studies}, \textit{DATABASE: The Journal of Biological Databases and Curation}, \textit{Field Methods}, \textit{Future Internet}, \textit{International Journal of Public Opinion Research}, \textit{Irish Political Studies}, \textit{Journal of Communication}, \textit{Journal of Elections, Public Opinion, and Parties}, \textit{Journal of Ethnic and Migration Studies}, \textit{Journal of Experimental Political Science}, \textit{Journal of Politics}, \textit{Journalism \& Mass Communication Quarterly}, \textit{Nature Climate Change}, \textit{PLoS One}, \textit{Political Analysis}, \textit{Political Behavior}, \textit{Political Communication}, \textit{Political Psychology}, \textit{Journal of Public Policy}, \textit{Political Research Quarterly}, \textit{Political Science Research and Methods}, \textit{Politics, Groups, and Identities}, \textit{Public Opinion Quarterly}, \textit{Quarterly Journal of Political Science}, \textit{Research \& Politics}, \textit{SAGE Open}, \textit{Scandinavian Political Studies}, \textit{Science}, \textit{Social Science Computer Review}}
	...
	\entry{Book Reviewer: MIT Press, Routledge Press}
	\entry{Other Peer Review Activity:\\ AAPOR Annual Conference, Center for Experimental Social Science at Nuffield College--Oxford, TESS: Time-Sharing Experiments for the Social Sciences}
	...
	\entry{Roundtable participant:\\ MPSA (2015), ISPP (2016)}
...
\topic{Public Engagement}
	\entry{Open Science Evangelism}
		...
		\subentry{\href{http://blogs.lse.ac.uk/impactofsocialsciences/2016/05/18/elsevier-purchase-ssrn-social-scientists-face-questions-over-whether-centralised-repository-is-in-their-interests/}{The LSE Social Science Impact Blog}}
		...
		\subentry{``\href{http://www.psychologytoday.com/blog/polarized}{Polarized},'' a \textit{Psychology Today} blog about psychology and public opinion (2012-2013)}
	...
	%\entry{Contributions to English-language \textit{Wikipedia} on topics related to political psychology and statistics as user \href{http://en.wikipedia.org/wiki/Special:Contributions/Thosjleep}{thosjleep} (2008-)}
